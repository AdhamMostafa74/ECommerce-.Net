...
public static class ProductErrors
{
    ...
    public static readonly Error InvalidPictureUrl = new(
        "Products.InvalidPictureUrl",
        "Product picture URL is required.",
        ErrorType.Validation);

    public static readonly Error InvalidPicturePublicId = new(
        "Products.InvalidPicturePublicId",
